...
final class PolicyView: UIViewController {
    ...
    enum Constants {
        ...
        Welcome to our recipe app! We're thrilled to have you on board. To ensure a delightful experience for everyone,
...
By using our recipe app, you agree to adhere to these rules. Thank you for being a part of our culinary community!
...
"""
    ...
    private func setupPolicyLabelConstraints() {
        ...
        policyLabel.bottomAnchor.constraint(equalTo: 
